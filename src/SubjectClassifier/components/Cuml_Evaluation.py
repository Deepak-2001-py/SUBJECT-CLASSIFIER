...
from cuml.model_selection import cross_val_score, GridSearchCV
import os
import pandas as pd
import time
# import sys
...
class Evaluation:
    ...
    def evaluation(self):
        ...
        y_train = y_train.to_numpy()  # or np.squeeze(y_train.values)
        y_test = y_test.to_numpy()  # or np.squeeze(y_test.values)
